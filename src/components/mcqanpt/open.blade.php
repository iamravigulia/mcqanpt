<div>
    ...
    <form action="{{route('fmt.mcqanpt.store')}}" method="post" class="fmt_box" enctype="multipart/form-data">
        ...
        <div class="fmt_headline">Add a MCQAnPT</div>
        <div>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 1</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_1" placeholder="Answer" >
            </div>
            <div>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 2</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_2" placeholder="Answer" >
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 3</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_3" placeholder="Answer" >
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 4</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_4" placeholder="Answer" >
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 5</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_5" placeholder="Answer" >
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
        ...
        <div class="fmt_flex">
            ...
            <div>
                <label class="fmt_label" for="">Answer Media 6</label>
                <input class="fmt_input" style="padding: 0;" type="file" accept="image/*" name="answer_media_6" placeholder="Answer" >
            </div>
            <div>
                <label class="fmt_label" for="">Correct</label>
    ...
    {{--  --}}
    <form action="{{route('fmt.mcqanpt.csv')}}" method="POST" enctype='multipart/form-data' style="margin:20px 40px;">
        @csrf
        <input type="integer" name="problem_set_id" value="{{$pbs72 ?? ''}}" hidden style="border:1px solid #000000;">
        <input type="integer" name="format_type_id" value="{{$fmt72 ?? ''}}" hidden style="border:1px solid #000000;">
